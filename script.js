...
Promise.all([
    ...
    const windowInnerHeight = document.documentElement.clientHeight * 0.3;
    ...
    //replace with HTML selector
    var selectedKeys = ['TSLA', 'MSFT','BAC'];
...
function sankey(nodeIdx) {
      ...
      sankey.slinks =  function(_, min, max) {
